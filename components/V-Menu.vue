<template>
    <div ref="menu" class="menu" role="menu" data-scroll-sticky>
        ...
        >
            <div
                role="button"
                class="menu__back-item__content"
                tabindex="0"
        ...
        <div class="menu__back-item">
            <div
                class="
                    menu__back-item__content menu__back-item__content--no-anim
                "
            >
        ...
        return {
            ...
            navigationalLinks: [
                ...
                },
                {
                    label: 'Papers',
                    action: () => {
                        this.boss('https://papers.sgsavu.com');
                    }
                },
                {
                    label: 'Music',
                    action: () => {
                        this.boss('https://music.sgsavu.com');
                    }
                }
            ],
            socialLinks: [
