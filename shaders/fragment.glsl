...
void main(void) {
    ...
    float sz = rand(vec2(20.0,40.0));

    // TITANIUM 
    // vec3 color2 = vec3(133.0, 147.0, 152.0);
    // vec3 color3 = vec3(40, 48, 72);

    // INFLUENZA 
    // vec3 color2 = vec3(192, 72, 72);
    // vec3 color3 = vec3(72, 0, 72);

    // DELICATE
     vec3 color3 = vec3(211, 204, 227);
     vec3 color2 = vec3(233, 228, 240);

    // PURPLE PARADISE
    // vec3 color3 = vec3(29, 43, 100);
    // vec3 color2 = vec3(248, 205, 218);

    // AQUAMARINE
    // vec3 color3 = vec3(26, 41, 128);
    // vec3 color2 = vec3(38, 208, 206);

    // LEAN
    // vec3 color2 = vec3(255.0, 230.0, 237.0);
    // vec3 color3 = vec3(102.0, 0.0, 255.0);
